...
import com.ruoyi.sky.service.IDishService;
...
public class DishController extends BaseController
{
     ...
     * 查询菜品管理列表
     */
    @PreAuthorize("@ss.hasPermi('sky:dish:list')")
    @GetMapping("/list")
     ...
     * 导出菜品管理列表
     */
    @PreAuthorize("@ss.hasPermi('sky:dish:export')")
     ...
     * 获取菜品管理详细信息
     */
    @PreAuthorize("@ss.hasPermi('sky:dish:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增菜品管理
     */
    @PreAuthorize("@ss.hasPermi('sky:dish:add')")
     ...
     * 修改菜品管理
     */
    @PreAuthorize("@ss.hasPermi('sky:dish:edit')")
     ...
     * 删除菜品管理
     */
    @PreAuthorize("@ss.hasPermi('sky:dish:remove')")
